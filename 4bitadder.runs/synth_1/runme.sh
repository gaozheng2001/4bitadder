...
HD_PWD='D:/DSD/Lab/4bitadder/4bitadder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_adder.tcl
