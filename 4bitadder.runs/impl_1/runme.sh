...
HD_PWD='D:/DSD/Lab/4bitadder/4bitadder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_adder.tcl -notrace
